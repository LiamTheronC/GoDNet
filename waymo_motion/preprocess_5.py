#This version of preprocess would downsample the graph by config['downsample_factor']
#to make it resource-friendly.
...
class Waymo_Motion_Preprocess_5:
