#This version of preprocess retains the original graph information, 
#hence it requires a significant allocation of traning resources.
...
class Waymo_Motion_Preprocess_4:
    ...
    def get_obj_feats(self, data: dict) -> dict:
        ...
        for i in range(len(data['object_ids'])):
            ...
            gt_pred2 = to_local(gt_pred, orig, theta)
    ...
    def get_graph(self, data: dict) -> dict:
        ...
        """
        get original graph information.
