...
from net import GreatNet, Loss, pre_gather
...
def main():
    ...
    config['val_split'] = '/home/avt/prediction/Waymo/data_processed/val'
    config["num_scales"] = 6
    config["n_map"] = 128
    config["n_actor"] = 128
    ...
    for epoch in range(num_epochs):
        train(net,train_loader,loss_f,optimizer,epoch,num_epochs)
        # if (epoch + 1) % 10 == 0:
        #     val(net,val_loader,loss_f,epoch,num_epochs)

    torch.save(net.state_dict(), 'model_Great_m1_weights.pth')
